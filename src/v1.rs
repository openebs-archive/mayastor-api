...
pub mod nexus {
    pub use super::pb::{
        ...
        NvmeAnaState, NvmeReservation, PauseRebuildRequest, PauseRebuildResponse,
        PublishNexusRequest, PublishNexusResponse, RebuildHistoryMapResponse, RebuildHistoryRecord,
